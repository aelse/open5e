...
has the following druid spells prepared:
    ...
    **Cantrips (at will)**: *druidcraft*, *produce flame*, :ref:`srd:shillelagh` 

    **1st level (4 slots)**: :ref:`srd:entangle`, :ref:`srd:longstrider`, *speak with animals*, :ref:`srd:thunderwave` 

    **2nd level (3 slots)**: *animal messenger*, :ref:`srd:barkskin`
